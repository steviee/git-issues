...
cp claude-skill/SKILL.md ~/.claude/skills/git-issues/SKILL.md
```
...
| `~/.claude/skills/git-issues/SKILL.md` | **Behavioral rules** — quality standards, creation protocol, recovery patterns (installed globally) |
